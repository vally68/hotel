...
$chambres = [];
for ($i = 1; $i <= 30; $i++) {
    $etat = ($i <= 5) ? false : true; // 3 premières chambres réservées
    $prix = ($i <= 15) ? 120 : 300;
    $wifi = ($i % 2 == 0);
...
$nbResahotel3 = Reservation::ReservationsHotel($reservations, "Hilton");
...
echo "<h4>Hotel Hilton : $nbResahotel3 réservation(s).</h4>";
